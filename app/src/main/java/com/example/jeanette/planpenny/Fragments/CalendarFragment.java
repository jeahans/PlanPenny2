...
public class CalendarFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        selectedDayMonthYearButton = (Button) frag.findViewById(R.id.selectedDayMonthYear);
        selectedDayMonthYearButton.setText("Selected: ");

        prevMonth = (Button) frag.findViewById(R.id.prevMonth);
        prevMonth.setOnClickListener(this);

        currentMonth = (TextView) frag.findViewById(R.id.currentMonth);
        currentMonth.setText(DateFormat.format(dateTemplate,
                _calendar.getTime()));

        nextMonth = (Button) frag.findViewById(R.id.nextMonth);
        nextMonth.setOnClickListener(this);

        calendarView = (GridView) frag.findViewById(R.id.calendar);
    ...
    public class GridCellAdapter extends BaseAdapter implements OnClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (day_color[1].equals("GREY")) {
                ...
                gridcell.setBackgroundColor(R.color.SecondaryColor);
            }
